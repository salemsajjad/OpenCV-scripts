...
def stackImages(imgArray, scale, lables=None):
    ...
    if len(lables) != 0:
        ...
        print(eachImgHeight)
        for d, c in itertools.product(range(rows), range(cols)):
...
while True:
    ...
    StackedImages = stackImages(([imgResize,imgGray,imgBlur],
                                 [imgCanny,imgDilation,imgEroded]),0.8,
                                (["Main","GrayScale","GaussianBlur"],
                                 ["Canny","Dilation","Eroded"]))
...
# import cv2
# import numpy as np
# img1 = cv2.imread(r'I:\OpenCV_tests\test1.jpg',0)
# img2 = cv2.imread(r'I:\OpenCV_tests\test2.jpg')
# print(img1.shape)
# print(img2.shape)
